...
function fetchJSONData(url) {
    fetch(url).then((response)=>response.json()) // Parse the JSON response
    .then((jsonData)=>{
        // Call the function to display the JSON data
        displayJSONData(jsonData);
    }).catch((error)=>{
...
const jsonURL = "https://raw.githubusercontent.com/ttministries/ttministries/main/verse.json";
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    if (motiLink) motiLink.addEventListener("click", function(event) {
...
},{}]},["6DoTH","adjPd"], "adjPd", "parcelRequire4992")
